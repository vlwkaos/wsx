...
| Context | Key |
|---|---|
| Workspace | `j/k` 이동, `h/l` 접기/펼치기, `Enter` 선택, `m`으로 선택한 project/session 순서 변경, `i` idle, `a` active, `n` attention session으로 이동 |
