...
- Size the Workspace scrollbar from rendered rows, scroll the tree by mouse wheel, right-align session listeners and stale labels, limit idle-session navigation to agent sessions, and keep agent labels neutral while restoring semantic state colors.
